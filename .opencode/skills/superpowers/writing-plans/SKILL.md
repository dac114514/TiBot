# Writing Plans (TiBot 定制版)

> 在原版 superpowers/writing-plans 基础上, 叠加 TiBot 项目规则
...
## TiBot 化改动点 vs 原版
1. **计划路径**: `docs/superpowers/plans/` (项目已有约定)
2. **派发指令必含** (新增必填项):
   - 目标文件清单
   - 禁止文件清单
   - 验收标准
...
- [ ] [可测量的标准 1]
- [ ] [可测量的标准 2]
**关联 spec**: docs/superpowers/specs/2026-MM-DD-xxx-design.md
**version bump**: commit 前必做 (CLAUDE.md 规则)
```
